...
class Depositor_ETH(SignalTemplate):
    def __init__(self, weight, ticker, signal_update_frequency_seconds, window_size=5, buy_threshold=0.8, buy_exit_threshold=0.4):
        ...
        self.url = 'https://api.glassnode.com/v1/metrics/eth2/staking_deposits_count?a=ETH&i=24h&referrer=charts'
